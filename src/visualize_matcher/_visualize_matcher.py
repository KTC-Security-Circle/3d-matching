...
class VisualizeMatcher:
    ...
    def _setup_app(self) -> None:
        ...
        layout.background_color = o3dv_gui.Color(1, 1, 1, 1)
    ...
    def _update_step(self) -> bool:
        ...
        self.label.text = "RANSAC Fitness: progressing..."

        def _task() -> None:
            self.label.text = f"Fitness: {result.fitness:.4f} | Inlier RMSE: {result.inlier_rmse:.4f}"
            self.scene.add_geometry(SOURCE_NAME, self.source.pcd, self.material)
